...
public class V8NAssert {
   ...
   * @param name  The field/attribute name that will be provided as the code of the ErrorMessage, if the value is invalid.
   ...
   * @param value The value to check.
   * @param name  The field/attribute name that will be provided as the code of the ErrorMessage, if the value is invalid.
   * @param index for collection based input; the position/index within the collection
   * @return null when the given input is valid, an ErrorMessage otherwise.
   */
  ...
  public static ErrorMessage requiredInput(String value, String name, Object index) {
    ...
    return valid ?
        null :
        new ErrorMessage.Builder().code(name).message(
   ...
   * @param value        The value to check.
   * @param name         The field/attribute name that will be provided as the code of the ErrorMessage, if the value is invalid.
   * @param errorMessage The error message to include if the given value does not evaluate to true
   * @return null when the given input is valid, an ErrorMessage otherwise.
   */
   ...
   *
   * @param value The {@link Map} to check.
   * @param name  The field/attribute name that will be provided as the code of the ErrorMessage, if the value is invalid.
   * @return null when the given input is valid, an ErrorMessage otherwise.
   */
   ...
   *
   * @param value The {@link Collection} to check.
   * @param name  The field/attribute name that will be provided as the code of the ErrorMessage, if the value is invalid.
   * @return null when the given input is valid, an ErrorMessage otherwise.
   */
