...
public class MoneyTest {
  ...
  public void testCantAddMixedCurrencies() {
    ...
    System.out.println(String
        .format("OOOOPS! I was expecting a validation exception for providing monies with mixed currencies: %s AND %s",
            m1.toString(USD_CURRENCY_FORMAT), m2.toString(USD_CURRENCY_FORMAT)));
  }

  @Test(expected = NumberFormatException.class)
  public void testCantBuildMoneyWithNonNumericAmount_12x4999() {
    new Money.Builder().amount("12x4999").build();
  }

  @Test(expected = NumberFormatException.class)
  public void testCantBuildMoneyWithNonNumericAmount__100() {
  ...
  @Test
  public void testCantBuildMoneyWithCommasInAmount() {
    new Money.Builder().amount("1,000").build();
  }

  @Test
  public void testCanBuildMoneyWithDollarSignPrefixedAmount() {
    new Money.Builder().amount("$100").build();
  }

  @Test
  public void testCanBuildMoneyWithDecimalPointInAmount() {
    new Money.Builder().amount("100.01").build();
  }

  @Test
  public void testBuilderWithIntAmount() {
    ...
    System.out.println(String
        .format("%s + %s == %s", m1.toString(USD_CURRENCY_FORMAT), m2.toString(USD_CURRENCY_FORMAT),
            expected.toString(USD_CURRENCY_FORMAT)));
  }

  @Test
  public void testBuilderWithNegativeIntAmount() {
    Money m1 = new Money.Builder().amount("12.4999").build();
    Money m2 = new Money.Builder().amount(-25).build();
